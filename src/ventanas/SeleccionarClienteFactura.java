 ...
 * @author Adrian
 */
public class SeleccionarClienteFactura extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SeleccionarClienteFactura
     */
    public SeleccionarClienteFactura() {
        initComponents();
        ...
        jTable_clientes.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e){
                ...
                int columna_point = 1;
                if(fila_point > -1){
                    cliente_factura = (String)model.getValueAt(fila_point, columna_point);
                    dispose();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione el cliente destinatario de la factura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarClienteFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionarClienteFactura().setVisible(true);
            }
        });
    }
