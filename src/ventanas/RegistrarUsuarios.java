...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if(rs.next()){
                ...
                if (validacion==0) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "ERROR al registrar usuario. Contacte con el administrador del sistema.");
                    }
                } else {
            ...
            JOptionPane.showMessageDialog(null, "ERROR al comparar usuario. Contacte con el administrador del sistema.");
        }
