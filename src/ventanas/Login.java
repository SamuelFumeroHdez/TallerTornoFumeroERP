...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        this.setTitle("Login al sistema");
        this.setLocationRelativeTo(null);
        
        ImageIcon wallpaper = new ImageIcon("src/images/fondo_pantalla_login.png");
        ...
        ImageIcon wallpaper_logo = new ImageIcon("src/images/LogotipoTallerTornoFumeroERP_1.png");
    ...
    private void jButton_AccederActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AccederActionPerformed
        ...
        if(!user.equals("") && !pass.equals("")){
            try {
                ...
                if(rs.next()){
                    String tipo_nivel = rs.getString("tipo_nivel"); //tipo_nivel guarda la info que contiene tipo_nivel en la base de datos
                ...
                JOptionPane.showMessageDialog(null, "ERROR al iniciar sesión. Informe al administrador del sistema");
